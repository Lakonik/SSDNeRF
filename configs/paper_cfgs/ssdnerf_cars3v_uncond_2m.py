...
train_cfg = dict(
    dt_gamma_scale=0.5,
    density_thresh=0.1,
    extra_scene_step=1,  # -1 + K_in (inner loop iterations)
...
custom_hooks = [
    ...
    dict(
        ...
        step=[0],
        by_epoch=False,
        load_from='cache/ssdnerf_cars3v_uncond/code'),
    dict(
        type='SaveCacheHook',
...
log_level = 'INFO'
load_from = 'work_dirs/ssdnerf_cars3v_uncond/ckpt/ssdnerf_cars3v_uncond/latest.pth'
resume_from = None
