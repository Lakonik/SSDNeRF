...
data = dict(
    ...
    train=dict(
        ...
        cache_path='/net/tscratch/people/plgmarzol/SSDNeRF_data/data/shapenet/cars_train_cache.pkl'),
    val_uncond=dict(
        type=dataset_type,
        ...
        cache_path='/net/tscratch/people/plgmarzol/SSDNeRF_data/data/shapenet/cars_test_cache.pkl'),
    val_cond=dict(
        type=dataset_type,
        data_prefix='/net/tscratch/people/plgmarzol/SSDNeRF_data/data/shapenet/cars_test',
